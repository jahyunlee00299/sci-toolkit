...
description: Layer skill for Mermaid diagram standards. Called by scientific-writing/manuscript-pipeline/literature-review when diagrams are needed. Also trigger directly when asked to "add diagram", "visualize relationship", or create documentation. Mermaid-first over matplotlib/AI images for structural diagrams.
...
### With `publication-figures`

`publication-figures` generates AI-powered publication-quality images (PNG). Use the Mermaid diagram as the **brief** for the schematic:

```
Workflow:
1. Create the concept as Mermaid in .md (this skill — Phase 1)
2. Describe the same concept to publication-figures for a polished PNG (Phase 3)
...
3. Use publication-figures only for figures that truly need photorealistic/complex rendering
```

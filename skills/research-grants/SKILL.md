...
**⚠️ MANDATORY: Every research grant proposal MUST include at least 1-2 AI-generated figures using the publication-figures skill.**
...
- Use the **publication-figures** skill to generate AI-powered publication-quality diagrams
- Simply describe your desired diagram in natural language
- Nano Banana Pro will automatically generate, review, and refine the schematic

**How to generate schematics:**
Invoke the **publication-figures** skill directly and describe the diagram you need (e.g., "generate a methodology flowchart showing Aim 1 → Aim 2 → Aim 3" or "create a project timeline Gantt chart"). The skill handles the generation, review, and refinement.

The publication-figures skill will automatically:
...
For detailed guidance on creating schematics, refer to the publication-figures skill documentation.
...
For detailed methodology guidance by discipline, refer to the "Approach" / "Research Design" sections of the relevant agency guideline (`references/nih_guidelines.md`, `references/nsf_guidelines.md`, `references/doe_guidelines.md`, `references/darpa_guidelines.md`, or `references/nstc_guidelines.md`).
...
For agency-specific timeline expectations, see the "Proposal Structure" sections in `references/nsf_guidelines.md`, `references/doe_guidelines.md`, `references/darpa_guidelines.md`, and the "Research Methods, Steps, and Timeline" section of `references/nstc_guidelines.md`.
...
For agency-specific expectations on investigator qualifications and team composition, see the "Investigator(s)" review criterion in `references/nih_guidelines.md` and the corresponding sections in `references/nsf_guidelines.md`, `references/doe_guidelines.md`, and `references/darpa_guidelines.md`.
...
For detailed budget guidance, refer to `assets/budget_justification_template.md` and the "Budget Preparation" / "Budget Considerations" sections of `references/nih_guidelines.md`, `references/nsf_guidelines.md`, `references/doe_guidelines.md`, and `references/nstc_guidelines.md`.
...
For detailed review criteria by agency, refer to `references/nstc_guidelines.md`.
...
For the full review criteria by agency, see the "Review Criteria" sections within each agency guideline: `references/nsf_guidelines.md`, `references/nih_guidelines.md`, `references/doe_guidelines.md`, `references/darpa_guidelines.md`, and `references/nstc_guidelines.md`.
...
For detailed program/mechanism guidance, refer to the "Key Application Types" and "Programs" sections of `references/nih_guidelines.md`, `references/nsf_guidelines.md`, `references/doe_guidelines.md`, and `references/darpa_guidelines.md`.
...
For detailed resubmission guidance, refer to the "Resubmission" sections of `references/nih_guidelines.md` and `references/nsf_guidelines.md`.
...
This skill includes comprehensive reference files covering specific aspects of grant writing. Each guideline file contains agency-specific sections on review criteria, budget preparation, timelines, and (where applicable) resubmission strategy, so consult the relevant agency file directly rather than a separate topical file:

- `references/nsf_guidelines.md`: NSF-specific requirements, review criteria, budget considerations, submission process, and resubmission policy
- `references/nih_guidelines.md`: NIH mechanisms, review criteria, budget preparation, review process, and resubmission (A1) strategy
- `references/doe_guidelines.md`: DOE programs, review criteria, and application procedures
- `references/darpa_guidelines.md`: DARPA BAAs, program offices, review criteria, and proposal strategies
- `references/nstc_guidelines.md`: Taiwan NSTC (CM03) requirements, budget categories, and review criteria
...
- `assets/budget_justification_template.md`: Budget justification structure, with worked examples by cost category and agency-specific notes

## Visual Materials

This skill does not bundle a schematic-generation script. For figures, Gantt charts, or diagrams, invoke the **publication-figures** skill directly (see "Visual Enhancement with Scientific Schematics" above).

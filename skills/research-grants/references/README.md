...
Budget development, review criteria, and timeline/project-management guidance are covered within each agency guideline file above (e.g., the "Budget Preparation," "Review Criteria," and "Proposal Structure" sections of `references/nih_guidelines.md`, `references/nsf_guidelines.md`, `references/doe_guidelines.md`, and `references/darpa_guidelines.md`), and in `assets/budget_justification_template.md`.

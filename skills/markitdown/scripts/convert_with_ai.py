...
def convert_with_ai(
    ...
    Args:
        ...
        model: Model name (default: anthropic/claude-opus-5.5)
...
Popular Models (use with --model):
  anthropic/claude-opus-5.5 - Recommended for scientific vision
  google/gemini-3-pro-preview   - Gemini Pro Vision
    ...
    parser.add_argument(
        ...
        help='Model to use via OpenRouter (default: anthropic/claude-opus-5.5)'
    )
    parser.add_argument(
        '--prompt-type', '-t',

...
### With `endnote-citation-injection` (Citation Insertion)
...
# Step 3: Hand the resolved DOI to the endnote-citation-injection skill
# to insert the unformatted {Author, Year #RecNum} citation into the manuscript
```

### With `publication-figures` (Diagrams)

```python
# Step 1: Research a process
result = researcher.research("How does the CRISPR-Cas9 gene editing mechanism work step by step")

# Step 2: Describe the desired diagram to the publication-figures skill
# e.g. "CRISPR-Cas9 gene editing workflow: guide RNA design -> Cas9 binding -> DNA cleavage -> repair pathway"
```

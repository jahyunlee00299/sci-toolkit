...
- Google Scholar / PubMed database searches (use the `research-search` skill)
...
| `research-search` | Google Scholar, PubMed, CrossRef database searches |
| `literature-review` | Systematic literature reviews across academic databases |
| `publication-figures` | Generate diagrams from research findings |

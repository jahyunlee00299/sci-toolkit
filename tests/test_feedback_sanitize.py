...
그 순간 같은 유출이 다시 통과한다.
  ...
  · 260706  claude-scientific-skills 의 research-lookup/sources/ 에 미공개
            ...
            같은 건에서 미공개 MPSP 수치($112.76/$98.58/91.9%)도 함께 발견.
...
MUST_FLAG = [
    ...
    ("미공개 MPSP 달러 수치",
     "MPSP 가 $112.76 으로 나오는데 이 계산이 맞는지 모르겠어요"),
    ("미공개 수율 퍼센트",
     "전환율 91.9% 데이터를 넣으면 피팅이 발산합니다"),
    ("역가 g/L",
